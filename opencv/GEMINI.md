...
앱 루트는 저장소의 `opencv/` 디렉터리입니다 (`;opencv/`에서 2026-06-29에 리네이밍).
...
| Variable | Purpose |
|----------|---------|
| `PHOTOCROPPER_LIBRARY_DB` | Override SQLite library DB path |
| `PHOTOCROPPER_OFFLINE=1` | Disable DNN face model download |
| `QT_QPA_PLATFORM=offscreen` | Headless Qt selftests |
| `PYTHONUTF8=1` | Stable Unicode console output on Windows |

See also: repository root `CONTRIBUTING.md`, `PROJECT_AUDIT.md`.
