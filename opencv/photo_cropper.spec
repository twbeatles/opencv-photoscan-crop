...
a = Analysis(
    ...
    hiddenimports=sorted(set([
        ...
        'photo_cropper.core.image.detection_pipeline',
        'photo_cropper.core.image.processor',
        'photo_cropper.core.image.geometry',
        'photo_cropper.core.scene_presets',
        'photo_cropper.core.multi_photo_detector',
